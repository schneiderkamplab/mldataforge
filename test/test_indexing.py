...
@pytest.mark.parametrize("fmt,param,sort_key,input_directory", [
    pytest.param("jinx", {"compression": None, "lazy": True, "mmap": True}, "def key(sample): return sample['id']", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    pytest.param("jinx", {"compression": None, "lazy": True, "mmap": True}, "def key(sample): return len(sample['input_ids'])", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    ("jinx", {"compression": None, "lazy": True, "mmap": True}, "def key(sample): return sample['id']", None),
    pytest.param("jinx", {"compression": "snappy", "lazy": True, "mmap": True}, "def key(sample): return sample['id']", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    pytest.param("jinx", {"compression": "snappy", "lazy": True, "mmap": True}, "def key(sample): return len(sample['input_ids'])", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    ("jinx", {"compression": "snappy", "lazy": True, "mmap": True}, "def key(sample): return sample['id']", None),
    pytest.param("jinx", {"compression": None, "lazy": False, "mmap": True}, "def key(sample): return sample['id']", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    pytest.param("jinx", {"compression": None, "lazy": False, "mmap": True}, "def key(sample): return len(sample['input_ids'])", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    ("jinx", {"compression": None, "lazy": False, "mmap": True}, "def key(sample): return sample['id']", None),
    pytest.param("jinx", {"compression": "snappy", "lazy": False, "mmap": True}, "def key(sample): return sample['id']", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    pytest.param("jinx", {"compression": "snappy", "lazy": False, "mmap": True}, "def key(sample): return len(sample['input_ids'])", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    ("jinx", {"compression": "snappy", "lazy": False, "mmap": True}, "def key(sample): return sample['id']", None),
    pytest.param("jinx", {"compression": None, "lazy": True, "mmap": False}, "def key(sample): return sample['id']", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    pytest.param("jinx", {"compression": None, "lazy": True, "mmap": False}, "def key(sample): return len(sample['input_ids'])", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    ("jinx", {"compression": None, "lazy": True, "mmap": False}, "def key(sample): return sample['id']", None),
    pytest.param("jinx", {"compression": "snappy", "lazy": True, "mmap": False}, "def key(sample): return sample['id']", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    pytest.param("jinx", {"compression": "snappy", "lazy": True, "mmap": False}, "def key(sample): return len(sample['input_ids'])", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    ("jinx", {"compression": "snappy", "lazy": True, "mmap": False}, "def key(sample): return sample['id']", None),
    pytest.param("jinx", {"compression": None, "lazy": False, "mmap": False}, "def key(sample): return sample['id']", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    pytest.param("jinx", {"compression": None, "lazy": False, "mmap": False}, "def key(sample): return len(sample['input_ids'])", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    ("jinx", {"compression": None, "lazy": False, "mmap": False}, "def key(sample): return sample['id']", None),
    pytest.param("jinx", {"compression": "snappy", "lazy": False, "mmap": False}, "def key(sample): return sample['id']", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    pytest.param("jinx", {"compression": "snappy", "lazy": False, "mmap": False}, "def key(sample): return len(sample['input_ids'])", "test.tokenized.jinx", marks=pytest.mark.dependency(depends=["trafos_test_tokenized_jinx"], scope="session")),
    ("jinx", {"compression": "snappy", "lazy": False, "mmap": False}, "def key(sample): return sample['id']", None),
